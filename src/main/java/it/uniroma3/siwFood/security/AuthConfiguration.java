...
public class AuthConfiguration {
	...
	protected SecurityFilterChain configure(HttpSecurity http) throws Exception {
		...
		.requestMatchers(HttpMethod.GET, "/cook/**", "/removeRecipe/**", "/formEditRecipe", "/formAddIngredientRecipe/**", "/removeIngredient/**").hasAnyAuthority("COOK", "ADMIN")
        .requestMatchers(HttpMethod.POST, "/addRecipe", "/updateRecipe", "/addIngredient/**").hasAnyAuthority("COOK", "ADMIN")
